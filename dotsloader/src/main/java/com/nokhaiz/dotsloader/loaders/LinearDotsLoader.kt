...
import com.nokhaiz.dotsloader.contracts.DotsLoaderBaseView
import com.nokhaiz.dotsloader.R
import com.nokhaiz.dotsloader.utils.Utils
import java.util.*
        ...
        for (i in 0 until noOfDots) {
            ...
            if (i + 1 == selectedDotPos) {
                canvas.drawCircle(
                        ...
                        (if (expandOnSelect) this.selRadius else radius).toFloat(), selectedCirclePaint!!)
